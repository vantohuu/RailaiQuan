...
public class Fragment_Bbq extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_bbq, container, false);
        unit();
        return view;
    }
    private void unit()
    {
        ...
        list = new ArrayList<>();
        ViewFlipper flipper;
        flipper = view.findViewById(R.id.ryc_view_flipper_bbq);
        ...
        list = data.getBbq();
        recyclerView = view.findViewById(R.id.ryc_view_bbq);
