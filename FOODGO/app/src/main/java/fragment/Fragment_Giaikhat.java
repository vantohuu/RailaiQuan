...
public class Fragment_Giaikhat extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_giaikhat, container, false);
        unit();
        return view;
    }
    private void unit()
    {
        ...
        list = new ArrayList<>();
        ViewFlipper flipper;
        flipper = view.findViewById(R.id.ryc_view_flipper_giaikhat);
        ...
        list = data.getGiaikhat();
        recyclerView = view.findViewById(R.id.ryc_view_giaikhat);
