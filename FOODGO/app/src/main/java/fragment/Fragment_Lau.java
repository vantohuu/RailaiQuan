...
public class Fragment_Lau extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_lau, container, false);
        unit();
        return view;
    }
    private void unit()
    {
        ...
        list = new ArrayList<>();
        ViewFlipper flipper;
        flipper = view.findViewById(R.id.ryc_view_flipper_lau);
        ...
        list = data.getLau();
        recyclerView = view.findViewById(R.id.ryc_view_lau);
