...
public class Fragment_Monxao extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_monxao, container, false);
        unit();
        return view;
    }
    private void unit()
    {
        ...
        list = new ArrayList<>();
        ViewFlipper flipper;
        flipper = view.findViewById(R.id.ryc_view_flipper_monxao);
        ...
        list = data.getMonxao();
        recyclerView = view.findViewById(R.id.ryc_view_monxao);
