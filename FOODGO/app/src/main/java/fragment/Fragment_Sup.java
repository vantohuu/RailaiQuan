...
public class Fragment_Sup extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_sup, container, false);
        unit();
        return view;
    }
    private void unit()
    {
        ...
        list = new ArrayList<>();
        ViewFlipper flipper;
        flipper = view.findViewById(R.id.ryc_view_flipper_sup);
        ...
        list = data.getSup();
        recyclerView = view.findViewById(R.id.ryc_view_sup);
